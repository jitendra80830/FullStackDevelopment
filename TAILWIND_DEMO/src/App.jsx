  ...
  return (
    <>
      ...
      <p className="text-lg underline font-bold mt-4 text-blue-600">
        Tailwind makes styling eazy
      </p>
      <div className="bg-gray-400 p-4 m-4">Backgroud color demo</div>
      <div className="bg-green-500 border border-green-600 p-4 rounded-lg m-4">
        Border style demo
      </div>
      <div className="grid grid-cols-3 gap-4 mt-4">
        <div className="bg-green-400 p-4 text-red-700">1</div>
        <div className="bg-blue-200 p-4 text-black">2</div>
        <div className="bg-green-400 p-4 text-white">3</div>
      </div>
      <div className="flex justify-center items-center  bg-gray-300 mt-4 flex-col p-4">
        <p className="text-xl font-bold">Test1</p>
        <p className="text-xl font-bold">Test2</p>
        <p className="text-xl font-bold">Test3</p>
      </div>
      ...
      <button className="px-6 py-2 m-4 bg-blue-400 text-white rounded-lg hover:bg-blue-800 transition duration-300">
        Click me
      </button>
      <button
        className="px-6 py-2 m-4 bg-red-500 text-white rounded-lg hover:bg-red-800 
      transition duration-500 ease-in-out transform hover:scale-120"
      >
        Click me
      </button>
      ...
      <div className="max-w-sm rounded-lg shadow-lg bg-indigo-100 p-6">
        ...
        <button
          className="px-6 py-2 m-4 bg-blue-400 text-white rounded-lg hover:bg-blue-700 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <div className="bg-blue-400 p-4">1</div>
      ...
      <div className="bg-easybytes-500 h-[165px] w-[300px] border-green-600 p-4 rounded-lg m-4 flex items-center justify-center">
        Theme Variabl demo
      </div>
      <div className="bg-primary font-display h-[165px] w-[300px] border-green-600 p-4 rounded-lg m-4 flex items-center justify-center">
        Custom and color theme vriable
      </div>
    </>
  );
}
