...
// //   setCart: () => {},
// //   addToCart: () => {
// //     console.log("Produc added to cart");
// //   },
// //   removeFromCart: () => {},
// //   totalQuantity: 0,
// // };
...
//   //intialize cart state from localstorage or as empty array
//   const [cart, setCart] = useState(() => {
//     try {
//       const storedcart = localStorage.getItem("cart");
//       return storedcart ? JSON.parse(storedcart) : [];
...
//   // save cart to localstorage whenever it chnage
...
//   return <CartContxt.Provider value={setCart}>{children}</CartContxt.Provider>;
// };
